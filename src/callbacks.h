// Corrected callbacks.h
// Added missing declarations from callbacks.c implementations
// Added alias for typo in interface.c
...
// Alias for typo in interface.c
#define on_im_stat_checknutton2_toggled on_im_stat_checkbutton2_toggled
...
void
on_rechercher_inscri_clicked           (GtkButton       *button,
                                        gpointer         user_data);
